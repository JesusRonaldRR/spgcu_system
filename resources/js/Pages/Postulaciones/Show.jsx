...
export default function Show({ auth, postulacion }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Detalle de Postulación (Vista FUT)</h2>}
        >
            <Head title={`FUT - ${user.nombres}`} />

            <div className="py-12 bg-gray-100">
                <div className="max-w-5xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white shadow-2xl p-8 min-h-screen border border-gray-300 relative text-sm">
