...
\fancyhead[R]{\thepage}
\fancyfoot[C]{Universidad Nacional de Moquegua}
...
El Sistema de Programación y Gestión del Comedor Universitario (SPGCU) es una plataforma web diseñada para automatizar y optimizar los procesos relacionados con el servicio de alimentación para estudiantes beneficiarios de la Universidad Nacional de Moquegua.
...
\begin{enumerate}
    \item Acceda a la URL del sistema: \texttt{http://spgcu.unam.edu.pe}
...
\begin{itemize}
    ...
    \item Correo: bienestar@unam.edu.pe
