...
APP_ENV=production
APP_DEBUG=false
APP_URL=https://spgcu.unam.edu.pe
...
sudo certbot --nginx -d spgcu.unam.edu.pe
\end{lstlisting}
...
\begin{itemize}
    \item \textbf{Área de Sistemas - UNAM}
    \item Correo: sistemas@unam.edu.pe
